...
function AppLayout() {
  ...
  const isAuth = ['/login', '/cadastro', '/esqueci-senha'].includes(window.location.pathname)
    ...
    <div className="app-layout">
      ...
      <div className="main-area">
        <Routes>
          ...
          <Route path="/lista" element={<PrivateRoute><MinhaLista /></PrivateRoute>} />
          ...
          {/* Detail */}
          <Route path="/filme/:id" element={<PrivateRoute><Detail type="filme" /></PrivateRoute>} />
          <Route path="/serie/:id" element={<PrivateRoute><Detail type="serie" /></PrivateRoute>} />
